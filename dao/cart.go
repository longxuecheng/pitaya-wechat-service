...
var columns_cart_all = []string{"id", "user_id", "session_id", "goods_id", "goods_sn", "stock_id", "goods_name", "market_price", "sale_unit_price", "quantity", "goods_spec_description", "goods_spec_ids", "checked", "list_pic_url"}
